    ...
    <PopoverPrimitive.Anchor asChild>
      <div
        ...
        className={cn(
          ...
          "flex min-h-7 flex-wrap items-center gap-1.5 rounded-md border bg-input",
          "px-2.5 py-1.5 text-[length:var(--ide-font-size-sm)] transition-[color,box-shadow]",
          "focus-within:ring-[3px] cursor-text",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex h-4 w-4 items-center justify-center rounded-sm opacity-50 hover:opacity-100 transition-opacity"
...
function ComboboxChipsInput({
  ...
  return (
    <input
      ...
      className={cn(
        "min-w-16 flex-1 bg-transparent outline-none placeholder:text-muted-foreground text-[length:var(--ide-font-size-sm)]",
        className
      )}
      {...props}
    />
  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground z-50 w-[var(--radix-popover-trigger-width)] overflow-hidden rounded-md border border-border",
...
function ComboboxEmpty({
  ...
  return (
    <div
      ...
      className={cn("py-4 text-center text-[length:var(--ide-font-size-sm)] text-muted-foreground", className)}
    >
      {children}
    </div>
  )
...
function ComboboxItem({ value: valueProp, children, className, disabled }: ComboboxItemProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-sm py-1.5 pl-2 pr-8 text-[length:var(--ide-font-size-sm)]",
    ...
    >
      {children}
      {isSelected && (
        <Check className="absolute right-2 h-4 w-4 shrink-0 opacity-100" />
      )}
    </div>
  )
}
